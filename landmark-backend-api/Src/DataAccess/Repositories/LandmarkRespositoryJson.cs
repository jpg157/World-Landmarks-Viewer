...
// public class LandmarkRepositoryJson : ILandmarkDataAccessor
// {
...
//     landmark.LandmarkCreationDate = DateTime.Now;//(LandmarkConstants.LANDMARK_CREATION_DATETIME_FMT);
//     // landmark.LandmarkLocation = new LandmarkLocationData { XCoord = 0.0, YCoord = 0.0 }; //TODO
    
//     // Update the ImageApiUrl field with placeholder value
...
//   {
//     List<Landmark> landmarks = await GetAllLandmarksFromJsonFile();
//     int indexOfExistingLandmark = landmarks.FindIndex(lmEntry => lmEntry.Id == id);
//     landmarks.RemoveAt(indexOfExistingLandmark);

//     LandmarksWrapper landmarkData = new LandmarksWrapper { Landmarks = landmarks };
